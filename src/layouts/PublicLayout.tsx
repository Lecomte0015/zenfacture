...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      {/* Menu mobile — conditionnel, pas toujours visible */}
      {open && (
        <div className="md:hidden border-t border-gray-100 bg-white px-4 py-4 space-y-1 shadow-lg">
          ...
          <div className="pt-3 flex flex-col gap-2 border-t border-gray-100 mt-2">
            ...
            <Link
              to="/auth/register"
              className="flex items-center justify-center px-4 py-2.5 text-sm font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700"
            >
